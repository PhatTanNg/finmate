...
const RULES = [
  ...
  { intent: 'query_passive', w: 8, t: (n) => has(n, 'thu nhap thu dong', 'dong tien thu dong', 'tien sinh tien', 'tien de ra tien', 'tien de nam yen', 'nen dau tu vao dau', 'dau tu vao dau', 'kenh dau tu', 'dau tu gi', 'lam sao co them thu nhap', 'lam sao de tien sinh loi', 'tien nhan roi nen lam gi', 'lo trinh dau tu', 'song bang tien lai', 'song bang lai', 'khong di lam van co tien') },
