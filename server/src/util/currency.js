...
export const CURRENCIES = {
  ...
  // Ba thị trường lao động ngoài nước lớn nhất của người Việt. Thiếu chúng thì
  // người đi xuất khẩu lao động — nhóm gửi kiều hối nhiều nhất — không mở nổi
  // tài khoản đúng đồng tiền họ đang kiếm.
  JPY: {
    code: 'JPY',
    name: 'Yên Nhật',
    symbol: '¥',
